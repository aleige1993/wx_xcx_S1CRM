...
/**
 * 2019.03.25 修改 multiple 为 int , 
 * 选中大于 multiple 时, 之间删除最前的一个
 * 选中等于 multiple 时, 关闭窗口
 */
const defaults = {
    ...
    methods: {
        ...
        addValue(value) {
            if (this.data.multiple) {
                ...
                if (this.data.multiple == arrValues.length) {
                  this.close()
                } else if (arrValues.length > this.data.multiple) {
